...
print_header("SCS009 CWE-78  TIER 1 — Smell Pattern Variants")
for t in tier1:
    print_row(t)
print(LINE)

print_header("SCS009 CWE-78  TIER 2 — Context Variants")
for t in tier2:
    print_row(t)
print(LINE)

if tier3:
    print_header("SCS009 CWE-78  TIER 3 — Known Limitation Cases (source-only files)")
    for t in tier3:
        print_row(t)
    print(LINE)
