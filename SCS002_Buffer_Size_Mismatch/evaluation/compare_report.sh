...
# -----------------------------------------------------------------------
# TIER 1 — Smell pattern variants table
# -----------------------------------------------------------------------
print_header("SCS002 CWE-680  TIER 1 — Smell Pattern Variants")
for t in tier1:
    print_row(t)
print(LINE)
...
# -----------------------------------------------------------------------
print_header("SCS002 CWE-680  TIER 2 — Context Variants")
for t in tier2:
    print_row(t)
print(LINE)
...
# -----------------------------------------------------------------------
print_header("SCS002 CWE-680  TIER 3 — Known Limitation Cases (expected: MISSED)")
for t in tier3:
    print_row(t)
print(LINE)
