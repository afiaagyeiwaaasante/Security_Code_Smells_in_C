...
print(f"{'='*52}")
print(f" CWE-195 Signed-to-Unsigned Conversion Report")
...
DETECTOR_MSGS = {
    "signed_malloc":  "Signed int passed as malloc() size without positivity guard",
    "signed_memcpy":  "Signed int passed as memcpy()/memmove() count without positivity guard",
    "signed_strncpy": "Signed int passed as strncpy() count without positivity guard",
}
...
for finding in findings:
    ...
    msg = DETECTOR_MSGS.get(detector, f"Signed-to-unsigned conversion error")
