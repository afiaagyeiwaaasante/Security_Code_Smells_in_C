...
print("  SCS005 CWE-401  Tool Comparison: SmellDetect vs cppcheck vs Joern")
print("=" * len(header_tool))
print(header_sub)
print(header_tool)
print(LINE)
...
print(f"  Detected       : SmellDetect detected {our_tp+our_fp}/{total}   cppcheck detected {cpp_tp+cpp_fp}/{total}   Joern detected {joern_tp+joern_fp}/{total}")
