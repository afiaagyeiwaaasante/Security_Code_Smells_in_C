...
# -----------------------------------------------------------------------
print_header("SCS003 CWE-476  TIER 1 — Smell Pattern Variants")
for t in tier1:
    print_row(t)
print(LINE)
...
# -----------------------------------------------------------------------
print_header("SCS003 CWE-476  TIER 2 — Context Variants")
for t in tier2:
    print_row(t)
print(LINE)
...
# -----------------------------------------------------------------------
print_header("SCS003 CWE-476  TIER 3 — Known Limitation Cases (expected: MISSED)")
for t in tier3:
    print_row(t)
print(LINE)
