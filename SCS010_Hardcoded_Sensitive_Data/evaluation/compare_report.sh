...
print_header("SCS010 CWE-259  TIER 1 — Smell Pattern Variants")
for t in tier1:
    print_row(t)
print(LINE)

print_header("SCS010 CWE-259  TIER 2 — Context Variants")
for t in tier2:
    print_row(t)
print(LINE)

if tier3:
    print_header("SCS010 CWE-259  TIER 3 — Known Limitation Cases (sink-only files)")
    for t in tier3:
        print_row(t)
    print(LINE)
