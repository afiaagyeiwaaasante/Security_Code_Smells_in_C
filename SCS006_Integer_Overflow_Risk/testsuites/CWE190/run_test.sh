...
for f in "$SCRIPT_DIR/add"/smell_*.c; do [ -f "$f" ] && run_smell_case "$f"; done
...
for f in "$SCRIPT_DIR/multiply"/smell_*.c; do [ -f "$f" ] && run_smell_case "$f"; done
...
for f in "$SCRIPT_DIR/square"/smell_*.c; do [ -f "$f" ] && run_smell_case "$f"; done
...
for f in "$SCRIPT_DIR/postinc"/smell_*.c; do [ -f "$f" ] && run_smell_case "$f"; done
