...
print_header("SCS006 CWE-190  TIER 1 — Smell Pattern Variants")
for t in tier1:
    print_row(t)
print(LINE)

print_header("SCS006 CWE-190  TIER 2 — Context Variants")
for t in tier2:
    print_row(t)
print(LINE)

if tier3:
    print_header("SCS006 CWE-190  TIER 3 — Known Limitation Cases (interprocedural)")
    for t in tier3:
        print_row(t)
    print(LINE)
